        ...
        <div class="um-col-1">
            ...
            <table id="address">
                <tr>
                    ...
                    <td class="slimField"><input class="field" id="street_number" name="load_address"
                ...
                <tr>
                    ...
                    <td class="slimField"><input class="field" name="province"
                                                 id="administrative_area_level_1" disabled="true" required></input></td>
                ...
                <tr>
                    ...
                    <td class="wideField" colspan="3"><input class="field" id="country" name="country" disabled="true" onfocusout="set_phone()" required></input></td>
                </tr>
            </table>
            <div >
                    ...
                    <div class="um-field-area">
                        ...
                        <div class="intl-tel-input allow-dropdown" style="width: 100%;">
                            ...
                            <input autocomplete="off" class="um-form-field valid um-iconed "
                                   ...
                                   style="font-size: 14px; padding-left: 48px !important;">
                        </div>
                    </div>
                </div>
            ...
            <div>
                <label><?=$this->lang->line('confirm_password');?><span class="um-req" title="Required">*</span></label>
...
<script>
//    jQuery('#mobile_number-58').focus(function (e) {
//        alert('fdsfsa')
//    });
    function validate() {
